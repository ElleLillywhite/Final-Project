...
def create_rooms():
    ...
    michaels_office = Room("michael's office", "temporary txt")
    michaels_office.add_item("cheese balls", "a large container filled with bright orange cheese balls")
    michaels_office.add_item("teeth", "chattering teeth toy")
    michaels_office.add_item("dundie", "Michael's worlds best boss dundie")
    michaels_office.add_item_to_use("teeth", "You twist the gear on the side of the teeth and they begin to chatter.")
    michaels_office.add_item_to_use("dundie","Michael turns his dundie towards you, just like in the intro.")
    michaels_office.add_item_to_use("mug", 'Dwight takes the WORLDS BEST BOSS mug and sets it on the floor to putt a golf ball into it')
    michaels_office.add_person("Michael", "Guess what, I have flaws. What are they? Oh, I don't know. I sing in the shower. Sometimes I spend too much\ntime volunteering. Occasionally I'll hit somebody with my car. So sue me.")
    michaels_office.add_person("Dwight", "I am fast. To give you a reference point, I'm somewhere between a snake and a mongoose… and a panther.")
    michaels_office.add_available_room("Bullpen")

    rooms[michaels_office.name] = michaels_office
